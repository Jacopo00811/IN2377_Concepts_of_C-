...
private:
    ...
    // Mapping to store last modification time of each file
    std::unordered_map<std::string, std::filesystem::file_time_type> fileLastModified;
    mutable std::string targetPath_;
};
