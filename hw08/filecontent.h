...
public:
    ...
    FileContent(FileContent&& other) noexcept = default;
    FileContent& operator=(FileContent&& other) noexcept= default;

    // Allow copy construction and assignment
    FileContent(const FileContent& other) = default;
    FileContent& operator=(const FileContent& other) = default;
